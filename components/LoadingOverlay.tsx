      ...
      <div className="absolute inset-0 bg-app-background/95 backdrop-blur-sm flex flex-col items-center justify-center z-50 text-text-primary p-6">
        <div className="max-w-lg w-full bg-[#161618] border border-[#313133] px-6 py-8 rounded-lg">
          <div className="flex items-start">
            ...
            <div>
              <h2 className="text-lg font-medium mb-3">Initialization Failed</h2>
          ...
          {isRateLimitError && (
            <div className="mt-4 bg-secondary/30 p-4 border-l-2 border-red-500">
              <div className="flex items-center mb-2">
                ...
                <h3 className="text-sm font-medium">GitHub API Rate Limit Exceeded</h3>
              </div>
              
              {rateLimitResetTime && (
                <p className="text-text-secondary text-xs">Rate limit will reset at: {rateLimitResetTime}</p>
              )}
          ...
          <div className="mt-6 pt-4 border-t border-panel">
            <p className="text-xs text-text-secondary">
              Please check the repository URL, your GitHub token (if required), and the browser console for more details. 
