...
export const Terminal = forwardRef<TerminalRef, TerminalProps>(
  ({ id, active = false, className, onCommand, onResize, mode = 'default', initialOptions }, ref) => {
    ...
    const { runTerminalCommand } = useWebContainer(ref as React.MutableRefObject<TerminalRef | null>);
